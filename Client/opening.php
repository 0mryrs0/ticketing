    ...
    <div id="page-content-wrapper">
      <nav class="navbar navbar-light bg-transparent py-3 px-4 position-sticky">
          <div class="d-flex align-items-center">
              ...
              <div>
                <h3 class="m-0 textcolor-light fw-bold text-center"><?php echo $pageName ?></h3>
          ...
          <div class="d-flex align-item-center justify-item-center">
            ...
            <h6 class="m-auto"><i class="bi bi-person me-2"></i><?php echo $user_data['client_name']?> <span id="admin"></span></h6>
            </div>
          </div>
      </nav>