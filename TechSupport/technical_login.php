...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if(!empty($email) && !empty($password)) {
        ...
        $query = "SELECT * FROM personnel WHERE email_address = '$email' AND department='Technical'  LIMIT 1";
...
<html lang="en">
<head>
    <title>Ticketing Login Tech Support</title>
    <meta charset="UTF-8">
...
<div class="container mt-2" style="width:100%" >
        <div class="container row m-auto p-5 w-100 h-75">
        <div class="col align-self-center justify-content-center ">
                ...
                <form method="post">
                    ...
                    <div class="w-100 text-center">
                        <button class="btn backgroundcolor-red text-white rounded-4 text-center mt-3 px-4" type="submit">Log in</button>
                    </div>
            ...
            <div class="col text-center align-self-center justify-content-center">
                <img src="../img/techSupport.png" style="width: 400px;">
            </div>
